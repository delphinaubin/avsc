 ...
 */
function BytesType(schema) { 
  this.isDecimalType = schema.logicalType === 'decimal';
...
BytesType.prototype.sample = function () { 
  if (this.isDecimalType) {
    return 0.1;
  }
  return utils.bufferFrom([256]);
};
...
RecordType.prototype._getConstructorName = function () {
  return this.name ?
    utils.capitalize(unqualify(this.name)) :
